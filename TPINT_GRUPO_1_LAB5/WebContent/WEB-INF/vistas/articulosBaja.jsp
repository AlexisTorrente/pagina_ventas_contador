...
<html>
	...
	<body>
		...
		<h1>Baja de articulos</h1>
		<form action="articulosBaja.html">
			ID del articulo: <input type="number" name="idArticulo" placeholder="Ingrese ID del articulo" maxlength="50" required>
			<br><br>
...
function getConfirmacionBaja(){
	return confirm("¿Desea dar de baja el articulo?");
	}
