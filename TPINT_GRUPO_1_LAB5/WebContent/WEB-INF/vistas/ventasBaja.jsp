...
<html>
	...
	<body>
		...
		<h1>Baja de ventas</h1>
		<form action="ventaBaja.html">
			Numero de venta: <input type="text" pattern="^[1-9]\d*$" title="Se debe rellenar con números" maxlength="10" name="idVenta" placeholder="Ingrese nro de venta" required>
			<br><br>
			<input type="submit" value="Dar de baja" name="btnBaja" onclick="return getConfirmacionBaja();">
			<br>
			<p>${ Mensaje }</p>
...
function getConfirmacionBaja(){
	return confirm("¿Desea dar de baja la venta?");
	}
</script>	
